...
const Contact = () => {
  return (
    <div>
      <section className="bg-pink-50 dark:bg-slate-800" id="contact">
        <div className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8 lg:py-20">
          <div className="mb-4">
            <div className="mb-6 max-w-3xl text-center sm:text-center md:mx-auto md:mb-12">
              <p className="text-base font-semibold uppercase tracking-wide text-pink-600 dark:text-pink-200">
                Contact
              </p>
            ...
            <div className="grid md:grid-cols-2">
              <div className="h-full pr-6">
                ...
                <ul className="mb-6 md:mb-0">
                  <li className="flex">
                    <div className="flex h-10 w-10 items-center justify-center rounded bg-pink-600 text-gray-50">
                      <svg
              ...
              <div className="card h-fit max-w-6xl p-5 md:p-12" id="form">
                ...
                <form id="contactForm">
                  ...
                  <div className="text-center">
                    <button
                      type="submit"
                      className="w-full bg-pink-500 text-white px-6 py-3 font-xl rounded-md sm:mb-0"
                    >
                      Send Message
                    </button>
                  </div>
