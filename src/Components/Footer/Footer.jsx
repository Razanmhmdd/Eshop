  ...
  return (
    <>
      ...
      <footer className="text-black">
        {/* <!-- Main footer --> */}
        <div className="pt-16 pb-12 text-sm border-t border-pink-200 bg-pink-100">
              ...
              >
                ...
                >
                  <svg
                    ...
                    className="w-6 h-6 shrink-0 bg-pink-500"
                  >
                    <path
                      fillRule="evenodd"
                      clipRule="evenodd"
              ...
              >
                ...
                <ul>
                  <li className="mb-2 leading-6">
                    <a
                      href="javascript:void(0)"
                      className="transition-colors duration-300 hover:text-pink-500 focus:text-pink-600"
                    >
                      {" "}
                      Features{" "}
                    </a>
        ...
        {/* <!-- Sub Footer --> */}
        <div className="py-4 text-sm border-t border-slate-200 bg-pink-100">
          <div className="container px-6 mx-auto">
            <div className="grid items-center grid-cols-4 gap-6 md:grid-cols-8 lg:grid-cols-12">
              <div className="col-span-2 md:col-span-4 lg:col-span-6">
                Designed & Developed By Siliconradon Networks.com
              </div>
              <nav
